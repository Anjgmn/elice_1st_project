...
export class UserRepository {
   ...
   */
  async register(registerUserRequest) {
    try {
  ...
  async getJwtToken(loginRequest) {
   ...
   */
  async updateUser(updateUserRequest, jwtToken) {
    try {
